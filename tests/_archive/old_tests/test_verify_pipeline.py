#!/usr/bin/env python3
# Status: experimental
# Path: tests/test_verify_pipeline.py — pytest
...
Return JSON:
{
  ...
  "feedback": {
    "P_Qwen30B": {"model":"proposer","role":"proposer","score":0,"strengths":[],"weaknesses":[],"improvements":[]},
    "R_Qwen14B": {"model":"reflector","role":"reflector","score":0,"strengths":[],"weaknesses":[],"improvements":[]},
...
def main():
    ...
    resp = call_llm(messages, model="verifier",
