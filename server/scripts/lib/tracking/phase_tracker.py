...
RULES: dict[str, dict[str, Callable[[], bool]]] = {
    ...
    "1": {
        ...
        "MCP SSE": lambda: svc_active("container-devforge-api"),
        "ingest": lambda: svc_active("container-devforge-api"),
        "cli": lambda: file_exists("/opt/projects/server/scripts/cli.py"),
        "stats": lambda: svc_active("container-devforge-api"),
        ...
        "session_guard": lambda: file_exists("/opt/projects/server/scripts/session_guard.py"),
        "session_start": lambda: file_exists("/opt/projects/server/scripts/session_start.py"),
