...
GROUP_SECRETS = {
    ...
    # Azure Service Principals (renamed from ACCOUNT1-4)
    "AZURE_SP_20137133_CLIENT_ID": ["AZURE_SP_20137133_CLIENT_ID"],
    "AZURE_SP_20137133_CLIENT_SECRET": ["AZURE_SP_20137133_CLIENT_SECRET"],
    "AZURE_SP_20137133_TENANT_ID": ["AZURE_SP_20137133_TENANT_ID"],
    "AZURE_SP_MINIPARK4U_CLIENT_ID": ["AZURE_SP_MINIPARK4U_CLIENT_ID"],
    "AZURE_SP_MINIPARK4U_CLIENT_SECRET": ["AZURE_SP_MINIPARK4U_CLIENT_SECRET"],
    "AZURE_SP_MINIPARK4U_TENANT_ID": ["AZURE_SP_MINIPARK4U_TENANT_ID"],
    "AZURE_SP_KUHWADOCS_CLIENT_ID": ["AZURE_SP_KUHWADOCS_CLIENT_ID"],
    "AZURE_SP_KUHWADOCS_CLIENT_SECRET": ["AZURE_SP_KUHWADOCS_CLIENT_SECRET"],
    "AZURE_SP_KUHWADOCS_TENANT_ID": ["AZURE_SP_KUHWADOCS_TENANT_ID"],
    "AZURE_SP_MESIDS_CLIENT_ID": ["AZURE_SP_MESIDS_CLIENT_ID"],
    "AZURE_SP_MESIDS_CLIENT_SECRET": ["AZURE_SP_MESIDS_CLIENT_SECRET"],
    "AZURE_SP_MESIDS_TENANT_ID": ["AZURE_SP_MESIDS_TENANT_ID"],
    # Other secrets (renamed to match GitHub)
    "DATAIMPULSE_PROXY_KEY": ["DATAIMPULSE_PROXY_KEY"],
    "DUCKDNS_TOKEN_KEY": ["DUCKDNS_TOKEN_KEY"],
    "DROPLR_USER": ["DROPLR_USER"],
    "DROPLR_PASS": ["DROPLR_PASS"],
    "DEVFORGE_ENCRYPTION_PASSPHRASE": ["DEVFORGE_ENCRYPTION_PASSPHRASE"],
    "HUGGINGFACE_API_KEY": ["HUGGINGFACE_API_KEY"],
    "DEVFORGE_LITELLM_MASTER_KEY": ["DEVFORGE_LITELLM_MASTER_KEY"],
    "MASKPROXY_PROXY_KEY": ["MASKPROXY_PROXY_KEY"],
    "GMAIL_SMTP_MINIPARK4U": ["GMAIL_SMTP_MINIPARK4U"],
    "DEVFORGE_POSTGRES_PASSWORD": ["DEVFORGE_POSTGRES_PASSWORD"],
    "ZIGHT_API_KEY": ["ZIGHT_API_KEY"],
}
