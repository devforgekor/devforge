...
def main():
    ...
    lines.append("  specs/system-design.yaml — architecture, containers, network, DB schema")
    ...
    lines.append("Worklog: auto-generated by turn_watcher + worklog_generator")
