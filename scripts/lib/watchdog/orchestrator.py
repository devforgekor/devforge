...
def _ping_external() -> None:
    """외부 dead-man's switch 핑. HTTP(DEVFORGE_WATCHDOG_PING_URL) 또는 SSH(DEVFORGE_WATCHDOG_PING_SSH)."""
    global _last_ssh_ping
    url = os.environ.get("DEVFORGE_WATCHDOG_PING_URL", "")
    if url:
        try:
            ...
            pass
    host = os.environ.get("DEVFORGE_WATCHDOG_PING_SSH", "")
