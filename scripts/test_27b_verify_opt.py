...
from prj_cycle import kill_all, wait_health, wait_probe, SYS_VERIFY, RUBRIC, MODE_FILE_A, MODE_FILE_B, log as plog

EXPER_DIR = '/opt/projects/server/data/experiment'
PORT = 8081

MODEL_REGISTRY["Qwen27B"] = {"port": 8081, "temp": 0.10, "max_tokens": 3072, "timeout": 7200}
...
def run_verify():
    ...
    try:
        r = call_llm(
            ...
            model="Qwen27B", max_tokens=3072, temperature=0.1,
