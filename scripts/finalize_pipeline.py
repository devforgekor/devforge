...
night_verify = state.get('night_verify', {})
py_v = state.get('python_verify', {})
day_verify = state.get('day_verify', {})
...
summary = {
    ...
    "phases": {
        ...
        "phase1_day_verify": {"verdict": day_verify.get("final_verdict", "?"), "confidence": day_verify.get("confidence", 0)},
        ...
        "phase4_night_verify": {"verdict": night_verify.get("final_verdict", "?"), "confidence": night_verify.get("confidence", 0), "synthetic": True},
...
print(f"  Phase 1 (day_verify):      ✅ {day_verify.get('final_verdict','?')} (conf={day_verify.get('confidence',0)})")
...
print(f"  Phase 4 (night_verify):     ⚠️ synthetic (hw limit) | verdict={night_verify.get('final_verdict','?')}")
