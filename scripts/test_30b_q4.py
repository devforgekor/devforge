...
from prj_cycle import kill_all, wait_health, wait_probe, SYS_P, MODE_FILE_B, RUBRIC, log as plog
...
Q4_MODEL = "Qwen30B"  # re-use key, port 8080
Q4_MODE = "review-p"
...
try:
    for use_json in [True, False]:
        try:
            r = call_llm(
                [{"role": "system", "content": SYS_P_RUBRIC},
